...
\address{Email: \href{mailto:dylanrandle@gmail.com}{\texttt{dylanrandle@gmail.com}} \\ Phone: \texttt{+1-857-999-7442 }}
...
%
%	\item \href{https://github.com/dylanrandle/deepgen}{Personal project} which developed variational auto-encoder (VAE) generative models of images with convolutional neural networks; implemented ResNet VAE and produced realistic samples; enabled control of high-level image features by conditioning on auxiliary input data
%	
%\end{rSubsection}
