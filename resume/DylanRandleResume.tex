...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  \href{https://dylanrandle.github.io/}{\uline{dylanrandle.github.io}} $|$ % row = 2, col = 1
...
\section{Summary}
\small{
  I am a highly skilled data scientist with over \textbf{4 years of experience} building \textbf{machine learning systems} for applications in \textbf{robotics}, \textbf{computer vision}, and \textbf{natural language processing}. My work has been \textbf{published} and \textbf{patented}, and I was invited to present it at both \textbf{MIT} and \textbf{Harvard}.
}
%--------------------------------------------
...
\resumeHeadingListStart{}
  ...
  {Amazon Robotics}{July 2020 -- Present}
    \resumeItemListStart{}
      \resumeItem{Developed ML systems for \textbf{robotic item manipulation} (e.g. grasp learning, damage prediction, damage detection)}
      \resumeItem{Developed optimization algorithms for mobile robot \textbf{path planning}}
      \resumeItem{Responsible for performance improvements worth \textbf{+\$100MM/year}}
      \resumeItem{Recipient of \textbf{Inventor Award}}
      \resumeItem{Paper \textbf{published} at internal conference ($\leq 5\%$ accepted)}
    \resumeItemListEnd{}

  \resumeQuadHeading{Data Scientist}{Toronto, ON, Canada}
  {Hubdoc Inc}{Feb 2017 -- July 2018}
    \resumeItemListStart{}
      \resumeItem{Developed \textbf{LSTM-based NLP system} for extracting accounting information from financial documents}
...
\section{Education}
  \resumeHeadingListStart{}
    ...
    \resumeItemListStart{}
      \resumeItem{Scholarship in Applied Computation, Distinction in Teaching}
    \resumeItemListEnd{}
    ...
    \resumeItemListStart{}
      \resumeItem{High Honors (\textit{magna cum laude}), Frank Kraft Award, Phi Beta Kappa, Tau Beta Pi, Alpha Pi Mu}
    \resumeItemListEnd{}
  \resumeHeadingListEnd{}
%---------------------------------------------
...
\section{Projects}
  \resumeHeadingListStart{}
    \resumeTrioHeading{Physics-Informed Neural Networks}{}{\href{https://github.com/dylanrandle/denn}{\uline{GitHub}}}
      \resumeItemListStart{}
        \resumeItem{Developed \textbf{GAN} framework for unsupervised learning of solutions to differential equations}
        \resumeItem{Workshop paper published at \textbf{ICML 2022}}
      \resumeItemListEnd{}
    \resumeTrioHeading{ML Trading System}{}{Proprietary}
      \resumeItemListStart{}
        \resumeItem{Developed \textbf{LDA-based NLP system} for trading US equities}
        \resumeItem{Deployed to production for \textbf{real-time trading}}
      \resumeItemListEnd{}
    \resumeTrioHeading{Generative AI for Human Faces}{}{\href{https://github.com/dylanrandle/deepgen}{\uline{GitHub}}}
      \resumeItemListStart{}
        \resumeItem{Developed \textbf{ResNet VAE} to generate human faces}
        \resumeItem{Code published to GitHub}
      \resumeItemListEnd{}
  \resumeHeadingListEnd{}
%--------------------------------------------
...
\section{Technical Skills}
  \resumeHeadingListStart{}
    \resumeSectionType{Languages}{:}{Python, Javascript/Typescript}
    \resumeSectionType{Frameworks}{:}{PyTorch, React Native}
    \resumeSectionType{Libraries}{:}{Numpy, Pandas, Scipy}
    \resumeSectionType{Dev Tools}{:}{AWS, Git, Firebase, Docker}
  \resumeHeadingListEnd{}
%--------------------------------------------
