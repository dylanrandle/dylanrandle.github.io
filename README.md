...
full-size `video` on the detail page. Entries with static images also provide a
`previewImages` list of responsive card sources and widths. Both collections
share the schema in `src/content.config.ts`.
