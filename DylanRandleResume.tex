  ...
  \resumeSubheading
    ...
    \resumeItemListStart
      \resumeItem{Data Engineering}
        {Built automated, scalable data pipeline for big data queries with Spark \& Hive on AWS Elastic Map Reduce}
      \resumeItem{Data Science}
        {Developed tree-based and neural network models for proprietary internal product;
        incorporated interpretability methods (PDP, ALE, SHAP) and uncertainty quantification}
    \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Production Deep Learning}
          ...
          text classification in financial documents. Extraction time reduced from 24 hours
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Camp Maintenance}
          {Built a new dock; fixed and renovated cabins. Leader of roofing crew }
      \resumeItemListEnd
