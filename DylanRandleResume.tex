...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Awards}
          {Applied Computation Scholarship}
      \resumeItemListEnd
    \resumeSubheading
  ...
  \resumeSubheading
    ...
    \resumeItemListStart
      \resumeItem{Deep Learning in Physics}
        ...
        Burgers' equation) in an unsupervised fashion.}
    \resumeItemListEnd
  ...
  \resumeSubheading
    ...
    \resumeItemListStart
      ...
      \resumeItem{Data Science}
        {Developed modular machine learning library for internal product. Included automatic data filtering, feature selection,
        linear models, random forests, gradient boosted trees, and feedforward neural networks. Leveraged interpretability algorithms
        (e.g. feature importance, accumulated local effects, Shapley additive explanations) for model understanding.
        Tech stack: Python, AWS EC2/S3, Pandas, NumPy, scikit-learn, XGBoost, Keras}
      \resumeItem{Data Product}
        ...
        Demonstrated efficacy and efficiency through targeted internal use cases. Tech stack: Python, Jupyter Notebook, IPython Widgets}
    \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Data Science}
          ...
          scrapers. Wrote reports and built data visualizations for company intranet in JavaScript D3}
