  ...
  \resumeSubheading
    ...
    \resumeItemListStart
      \resumeItem{Deep Learning in Physics}
        ...
        neural networks in a fully unsupervised manner. Researching methods for training Generative Adversarial Networks (GANs)
        and ensembles of neural networks to solve differential equations without access to ground truth data}
    \resumeItemListEnd
