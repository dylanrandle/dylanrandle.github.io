  ...
  \resumeSubheading
    ...
    \resumeItemListStart
      \resumeItem{Data Engineering}
        {Built automated, scalable data pipeline for big data queries with Spark on AWS Elastic Map Reduce}
      \resumeItem{Data Science}
        {Developed tree and neural network models for proprietary internal product;
        incorporated interpretability algorithms (e.g. PDP, ALE, SHAP)}
    \resumeItemListEnd
