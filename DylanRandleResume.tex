  ...
  \resumeSubheading
    ...
    \resumeItemListStart
      \resumeItem{Data Engineering}
        {Built fully-automated, scalable data pipelines for big data queries with Spark \& Hive on AWS Elastic Map Reduce}
      \resumeItem{Data Science}
        {Developed tree and neural network models for product performance predictions; additionally
        incorporated interpretability methods (ALE, LIME, Shapley values) and uncertainty quantification}
      \resumeItem{Data Product}
        {Prototyped a user interface in IPython and Jupyter for delivering models to customers
...
\section{Programming Skills}
  ...
  \linebreak
  \textbf{Technologies}{: AWS (EC2, EMR, S3), PySpark, OpenMP, Git}
  %  }
  % \resumeSubHeadingListEnd
