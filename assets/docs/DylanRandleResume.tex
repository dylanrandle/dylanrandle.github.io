...
\resumeHeadingListStart{}
  \resumeQuadHeading{Senior Applied Scientist}{North Reading, MA, USA}
  {Amazon}{Jul 2020 -- Present}
    \resumeItemListStart{}
      ...
      \resumeItem{Named inventor on multiple patents}
    \resumeItemListEnd{}
  \resumeQuadHeading{Data Scientist}{Toronto, ON, Canada}
  {Hubdoc (acquired for \$70MM USD)}{Feb 2017 -- Jul 2018}
    \resumeItemListStart{}
        \resumeItem{Started and led machine learning (ML) team at successful startup from ideation to production deployment}
        \resumeItem{Developed \& deployed AI system for natural language processing of financial documents, reducing data extraction time by ~99\% compared to manual processes}
        \resumeItem{Built the entire ML stack from model training to production inference}
    \resumeItemListEnd{}
