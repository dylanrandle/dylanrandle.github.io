...
\resumeHeadingListStart{}
  \resumeQuadHeading{Amazon Robotics}{North Reading, MA, USA}{Senior Applied Scientist}{Apr 2024 -- Present}
    \resumeItemListStart
      \resumeItem{Technical leader developing closed-loop AI policy learning systems for dexterous bimanual robotic manipulation using imitation and reinforcement learning.}
      \resumeItem{Developed first dexterous bimanual item manipulation policies at Amazon, achieving 92\% success rate on unseen items. Demonstrated to Jeff Bezos, Andy Jassy, and Amazon Board of Directors.}
    \resumeItemListEnd
  \resumeQuadHeadingChild{Senior Data Scientist}{Apr 2023 -- Apr 2024}
    \resumeItemListStart
      ...
      \resumeItem{Deployed first learned action model for \href{https://www.aboutamazon.com/news/operations/amazon-introduces-sparrow-a-state-of-the-art-robot-that-handles-millions-of-diverse-products}{\uline{Sparrow}}. Delivered performance improvements of +35\% and savings of \$10 million/year.}
    \resumeItemListEnd
