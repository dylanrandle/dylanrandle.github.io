...
\begin{tabularx}{\linewidth}{@{}m{0.8\textwidth} m{0.2\textwidth}@{}}
{
    ...
    \section{Summary}
    \small{
      Artificial intelligence (AI) and machine learning (ML) technical leader, scientist, and engineer with 7+ years experience and proven track record building and deploying AI/ML systems for robotics, computer vision (CV), and natural language processing (NLP).
    }
} & 
{
    \hfill
...
\resumeHeadingListStart{}
  ...
  \resumeQuadHeadingChild{Senior Data Scientist}{Apr 2023 -- Apr 2024}
    \resumeItemListStart
      ...
      \resumeItem{Deployed first learned action model for Amazon`s \href{https://www.aboutamazon.com/news/operations/amazon-introduces-sparrow-a-state-of-the-art-robot-that-handles-millions-of-diverse-products}{\uline{Sparrow}} robot. Delivered performance improvements of +35\% and savings of \$10 million/year.}
    \resumeItemListEnd
...
\section{Projects}
    \resumeItemListStart{}
        \resumeItem{
            \textbf{Rubik's Cube Solving Robot:}
            A robot that autonomously solves a Rubik's cube in under 3 seconds. Leverages integrated perception to inspect the cube, Kociemba's algorithm to plan a solution, and stepper motors to solve it. Demo available on my \href{https://dylanrandle.github.io/posts/Rubiks-Cube-Robot/}
            {\uline{website}.}
        }
    \resumeItemListEnd{}
